  ...
  return (
    <div>
      <Helmet>
        ...
        <meta
          name='description'
          content="I am not always online, but if you want to find me, it's easy"
        />
      </Helmet>
      <SectionWide>
      ...
      <SectionContent>
        ...
        <Typegraphy>
          ...
          <a
            target='_blank'
            rel='noopener noreferrer'
            href='https://twitter.com/iandycao'>
            Twitter
          </a>{' '}
          or{' '}
          <a
            target='_blank'
            rel='noopener noreferrer'
            href='https://www.weibo.com/enjoywound'>
            Weibo
          </a>
          , I also update some information in my Telegram channel, I upload some
          videos about my life and experience in Youtube regularly, welcome to{' '}
          <a
