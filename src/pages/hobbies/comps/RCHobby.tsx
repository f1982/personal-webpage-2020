  ...
  return (
    <Wrapper ref={containerRef}>
      ...
      <p>
        ...
        information that I can get. But actually, for a long period of time, I
        cannot get the right data or cannot find the right place to buy the
      ...
      <div id='links'>
        ...
        <a
          href='https://photos.app.goo.gl/TjSPdHm2zfGfzeA2A'
          target='_blank'
          rel='noopener noreferrer'>
