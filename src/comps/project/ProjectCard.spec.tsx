 ...
 * @param index
 */
function getStyledComponentStyles<T>(
  ...
  props
    ? (componentClass = styledComponent(props))
...
function getStyledComponentClassName<T>(
  styledComponent: Function,
  props: T | null = null
) {
  let componentClass = null
...
describe('<ProjectCard />', () => {
  ...
  test('should show specific style', () => {
    const { getByText } = render(<ProjectCard {...defaultProps} />)
    const style: any = getStyledComponentStyles<ProjectItemProp>(
      ProjectCard,
      defaultProps
    )
  ...
  test('should ', () => {
    ...
    const className = getStyledComponentClassName<ProjectItemProp>(
      ProjectCard,
      defaultProps
    )
